---
title: 配置 API7 Enterprise 与上游服务的 mTLS
...
* [安装 API7 Enterprise](../getting-started/install-api7-ee)。
* 在 API7 Enterprise 上创建令牌。
...
2. 为 API7 Enterprise 生成服务器密钥和证书，通用名设置为 `test.com`，并使用 CA 证书签名。
...
## 验证 API7 Enterprise 与上游服务之间的 mTLS
...
您应该会收到 `HTTP/1.1 200 OK` 响应，验证 API7 Enterprise 与上游服务之间的 mTLS 已成功配置。
